...
We've also been discussing whether or not it makes sense to set thresholds on anomalies or direct values. I think it make more sense to calcualte RPs on direct values in this specific use-case.


### Thresholds Set on Percentiles Directly

```{r}
gt_thresh_percentiles_straight
```



### Thresholds set on Z-score Percentiles
```{r indepVsdep_table}
