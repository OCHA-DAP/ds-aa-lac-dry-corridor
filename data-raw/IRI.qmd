...
Since this is a regional project I have fiddle around a bit to create an AOI/country config file
- create bbox in R and convert to python with `{reticulate}`
- create a dummy country config file `lac.yaml` it just contains "iso3:lac"
