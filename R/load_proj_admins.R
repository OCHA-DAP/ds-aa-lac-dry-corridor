...
load_proj_admins <- function(){
  # Nicaragua
  lyr_name_nic_adm <- c(adm0="nic_admbnda_adm0_inide_itos_20210826",
  ...
  lyr_name_gtm_adm <- c(adm0= "gtm_admbnda_adm0_ocha_conred_20190207",
  ...
  lyr_name_slv_adm <- c(adm0="slv_admbnda_adm0_gadm_20210204" ,
