...
## OCHA AOI Skill Summary

@tbl-ocha-skill-summary shows forecast skill for the selected OCHA AOIs used in the trigger optimization chapter.

```{r}
#| label: tbl-ocha-skill-summary
#| tbl-cap: "SEAS5 Forecast Skill for OCHA AOIs"
